...
import {
  ...
  CTA,
  SectionHead,
} from "../../../components/site/PageShell.jsx";
import {
  Parallax,
  Reveal,
  Stagger,
  ...
  TiltCard,
  WordReveal,
} from "../../../components/site/Reveal.jsx";
...
const values = [
  {
    Icon: Award,
    t: "Craft Above All",
    d: "We obsess over the details others overlook.",
  },
  {
    Icon: Heart,
    t: "Human First",
    d: "Behind every line of code is a person — and we lead with empathy.",
  },
  {
    Icon: Sparkles,
    t: "Bias for Excellence",
    d: "Good enough is never enough on this network.",
  },
  {
    Icon: Compass,
    t: "Long-Term Thinking",
    d: "We build relationships, not transactions.",
  },
];
...
const reasons = [
  {
    t: "Vetted Network",
    d: "Less than 2% of applicants make it onto HireTopCoder.",
    i: Network,
  },
  ...
  {
    t: "Global Coverage",
    d: "Experts across every timezone, ready when you are.",
    i: Globe2,
  },
];
    ...
    <>
      ...
      <section className="relative pt-20 md:pt-40 2xl:pt-50 pb-20  sm:px-4 overflow-hidden">
        ...
        <div className="relative w-full text-center">
          ...
          <h1 className="w-full font-display font-bold leading-[0.95] text-[clamp(2.2rem,6vw,5.5rem)] md:text-[clamp(2.5rem,6vw,6rem)] 2xl:text-[clamp(2.8rem,7vw,6.5rem)]">
            <WordReveal text="Building Digital" />
            <br />
            <span className="text-gradient-purple">
              <WordReveal text="Excellence Globally" />
            </span>
          </h1>
          <Reveal delay={0.3}>
            <p className="mt-3 md:mt-5 text-sm  md:text-base lg:text-xl  text-[#b1afb8] max-w-3xl mx-auto  leading-relaxed font-normal">
              HireTopCoder is a curated network of elite digital experts helping
              the world's most ambitious teams design, build and scale.
            </p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-12 items-center">
          <Reveal>
            ...
            <h2 className="text-2xl md:text-3xl lg:text-5xl font-bold tracking-tight leading-tight">
              ...
              <span className="text-gradient-purple">global network</span>.
            </h2>
          </Reveal>
          <Reveal delay={0.15}>
            <div className="space-y-4 text-foreground/75 text-sm md:text-base lg:text-xl  font-normal">
              <p>
                HireTopCoder started in 2019 as a tiny collective of designers
                and engineers shipping products for venture-backed startups.
                Within three years it grew into a global network spanning 40+
                countries.
              </p>
              <p>
                Today, HireTopCoder powers digital teams at fast-moving startups
                and enterprises alike — combining boutique craft with on-demand
                scale.
              </p>
            </div>
          </Reveal>
      ...
      <section className="relative px-4 sm:px-6 lg:px-15 1xl:px-20 2xl:px-25 py-10 lg:py-20">
        <SectionHead
          ...
          title={
            <>
              What drives us{" "}
              <span className="text-gradient-purple">forward</span>
            </>
          }
        />
          ...
          {[
            {
              Icon: Target,
              t: "Mission",
              d: "Make world-class digital talent instantly accessible to every ambitious team on Earth.",
            },
            {
              Icon: Compass,
              t: "Vision",
              d: "A future where geography no longer limits what a small team can build.",
            },
          ].map((x) => (
            <StaggerItem key={x.t}>
              <TiltCard className="glass group rounded-3xl p-10 h-full hover-glow-card">
                <div className="w-8 h-8 xl:w-10 xl:h-10 flex justify-center items-center shrink-0 border border-white/10 rounded-sm xl:rounded-md bg-primary/10 transition-colors group-hover:border-primary">
                  <span className="text-lg xl:text-2xl text-primary">
                    {" "}
                    <x.Icon />
                  </span>
                </div>
        ...
        <SectionHead
          ...
          title={
            <>
              ...
              <span className="text-gradient-purple">HireTopCoder</span>
            </>
          }
        />
          ...
          {team.map((m) => (
            <StaggerItem key={m.n}>
              <TiltCard className="group glass rounded-3xl overflow-hidden hover-glow-card">
                ...
                <div className="p-5">
                  <div className=" text-sm lg:text-base xl:text-lg font-bold tracking-tight">
                    {m.n}
                  </div>
                  <div className="text-[10px] lg:text-xs xl:text-sm text-foreground/65 font-medium">
                    {m.r}
                  </div>
                </div>
              </TiltCard>
      ...
      <section className="relative px-4 sm:px-6 lg:px-15 1xl:px-20 2xl:px-25 py-10 lg:py-20 overflow-hidden">
        <SectionHead
          ...
          title={
            <>
              A network{" "}
              <span className="text-gradient-purple">without borders</span>
            </>
          }
        />
          ...
          {reach.map((m) => (
            <StaggerItem key={m.l}>
              <div className="glass group rounded-2xl p-5 lg:p-7 text-center hover-glow-card">
                ...
                <div className="mt-2 text-3xl lg:text-4xl font-extrabold tracking-tight text-gradient-purple">
                  {m.v}
                </div>
                <div className="mt-2 text-xs lg:text-sm text-foreground/70 font-medium">
                  {m.l}
                </div>
              </div>
            </StaggerItem>
      ...
      <CTA
        title={
          <>
            Let's build{" "}
            <span className="text-gradient-purple">something together</span>
          </>
        }
        btn1name="Start Hiring Talent"
        btn1href="/"
        btn2name="Join The Network"
        btn2href="/contact"
      />
    </>
  );
