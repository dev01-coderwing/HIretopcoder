...
export default function Page() {
      ...
      <div className="grid pt-10 pb-20 lg:mt-25 gap-15 lg:gap-30">
        <Reveal>
          <div className="grid justify-center items-center gap-15 pt-15 ">
            <div>
              <h2 className="text-2xl md:text-3xl lg:text-5xl text-center font-bold leading-[1.05]">
                How Its Work
              </h2>
            </div>
            <div>
        ...
        <div className="grid justify-center items-center gap-15">
          <HeadSection
            name="Ideal For"
            des="Specialized teams for specific engineering milestones."
        ...
        <div className="px-4 sm:px-10 lg:px-20 1xl:px-30 2xl:px-45">
          <Reveal>
            <div className="hover-glow-card bg-[oklch(0.18_0.02_290_/_0.7)] border border-primary/50 rounded-2xl overflow-hidden shadow-2xl flex flex-col md:flex-row">
              {/* Left Column: Details & Features */}
              <div className="flex-1 p-8 sm:p-10 flex flex-col justify-between ">
                <HeadSection
                  name="Monthly Retainer Model"
                  des=" Simple, predictable billing with no hidden fees. Focus on
  ...
  {/* Left */}
  <div>
    <p className="text-primary font-bold">Case Study</p>
  </div>

  {/* Center */}
  <div className="text-center">
    <h2 className="text-2xl md:text-3xl lg:text-5xl font-bold">
      Success With Broker Remarks
    </h2>
  </div>
  ...
  <div className="flex justify-end">
    ...
    >
      Explore More Stories
          ...
          <div className="">
            <div className="hover-glow-card bg-[oklch(0.18_0.02_290_/_0.7)] border border-primary/50 hover:border-primary rounded-2xl overflow-hidden shadow-2xl grid grid-cols-1 lg:grid-cols-12 min-h-[420px]">
              ...
              <div className="lg:col-span-5 p-8 sm:p-10 flex flex-col justify-between bg-[#14131D] border-t lg:border-t-0 lg:border-l border-white/[0.08]">
                ...
                <div className="bg-[#191823] border-l-2 border-primary p-6 rounded-r-xl mb-8">
                  <p className="text-base sm:text-lg text-[#F4EFFB] font-medium italic leading-relaxed">
                    &ldquo;The dedicated squad from HireTopCoder integrated
                    seamlessly into our Slack and Jira. It felt like they were
        ...
        <CTA
          title={
            <>
              Ready to Build Your{" "}
              <span className="text-gradient-purple">Elite Squad</span>?
            </>
          }
          des="Get a tailored proposal and team roadmap from our delivery experts within 24 hours."
          btn2name="Talk To Expert"
          btn2href="/contact"
        />
      </div>
    </section>
    ...
    <>
      ...
      {cards.map((card, index) => {
        ...
        return (
          <div
            key={index}
            className="bg-[oklch(0.18_0.02_290_/_0.7)]  hover-glow-card
  border border-primary/50 rounded-2xl p-7 sm:p-8 flex flex-col justify-between hover:border-primary transition-all duration-300 group cursor-pointer"
          >
