...
export function PrimaryButton({
  ...
  return (
    <Link
      href={href}
      className={`group inline-flex items-center gap-2 expert-btn text-[#381385] font-bold tracking-tight rounded-full px-3 py-2 md:px-6 md:py-3  lg:px-8 lg:py-4 text-xs md:text-[15px] lg:text-base 1xl:text-lg  2xl:text-[22px] ${className}`}
    >
      {children}
...
export function GhostButton({ href = "/", children, className = "", ...rest }) {
  return (
    <Link
      href={href}
      {...rest}
